  ...
  return (
    <div className="card">
      <Link
        ...
        <img
          src={
            image ? image : strCategoryThumb ? strCategoryThumb : strMealThumb
          }
          ...
          style={
            name
              ...
              : strMealThumb
              ? { width: "100%", height: "25rem", borderRadius: "1rem" }
              : {}
          }
        />
      </Link>
      ...
      <div className="card-body">
        ...
        {title && (
          <button
            ...
            onClick={() => {
              swal("Comming soon", "This menu is not defined", "info");
            }}>
            Read More
          </button>
        )}
        ...
        {strMealThumb ? (
          isBasket ? (
            <button
              className={"btn btn-outline-dark"}
              onClick={() => handleRemoveClick(idMeal)}>
              Remove
            </button>
          ) : (
            <button
